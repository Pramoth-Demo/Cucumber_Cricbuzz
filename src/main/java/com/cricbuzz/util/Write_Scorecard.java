...
public class Write_Scorecard extends BaseClass {
	...
	public Write_Scorecard() throws IOException {                                                       // Constructor
	...
	public void FeedingTitleOfTheMatch() {
		...
		title=MatchPage.matchTitle.getText();
	...
	public void FeedingMatchStatus() {                                                         // Match Status
		...
		try {
			...
			status=status1.getText();
				...
				WebElement status1= MatchPage.matchStatusCompleted;
				colour="Blue";
				status=status1.getText();
			}
